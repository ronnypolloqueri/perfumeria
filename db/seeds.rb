...
Marca.create(descripcion: 'Armani')
Marca.create(descripcion: 'Antonio Banderas')
Marca.create(descripcion: 'Bvlgari')
Marca.create(descripcion: 'Calvin Klein')
Marca.create(descripcion: 'Dior')
Marca.create(descripcion: 'Dolce&Gabbana')
Marca.create(descripcion: 'Escada')
Marca.create(descripcion: 'Gucci')
Marca.create(descripcion: 'Lancome')
Marca.create(descripcion: 'Jean Paul Gaultier')
Marca.create(descripcion: 'Ralph Lauren')
Marca.create(descripcion: 'Lancome')
Marca.create(descripcion: 'Tommy Hilfiger')
Marca.create(descripcion: 'Versace')
Marca.create(descripcion: 'Yves Saint Laurent')
